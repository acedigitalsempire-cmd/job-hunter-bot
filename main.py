...
<p style="color:#555;">No remote customer support jobs posted in last 48 hours.</p>
<p style="color:#888;font-size:12px;">Date: {today}</p>
</div></body></html>"""
...
<a href="{link}" style="color:#2ecc71;font-size:12px;font-weight:bold;">🔗 Click to Apply</a>
</td>
<td style="padding:12px;border-bottom:1px solid #eee;color:#555;">{job['company']}</td>
<td style="padding:12px;border-bottom:1px solid #eee;color:#555;">{job['location']}</td>
<td style="padding:12px;border-bottom:1px solid #eee;">
<span style="background:{source_color};color:white;padding:3px 8px;border-radius:10px;font-size:11px;">{source}</span>
</td>
<td style="padding:12px;border-bottom:1px solid #eee;">
<a href="{link}" style="background:#2ecc71;color:white;padding:8px 16px;border-radius:4px;text-decoration:none;font-weight:bold;font-size:13px;">Apply →</a>
</td>
<td style="padding:12px;border-bottom:1px solid #eee;color:#777;font-size:12px;">{keyword_str}</td>
<td style="padding:12px;border-bottom:1px solid #eee;color:#e67e22;font-size:12px;">{skills_str}</td>
</tr>"""
...
<p style="color:white;font-size:18px;margin:10px 0 0;"><strong>{len(jobs)}</strong> Remote Customer Support Job(s) Found</p>
